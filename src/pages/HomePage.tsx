  ...
  return (
   ...
   <RetroGrid/>
      ...
      <section className="py-20 sm:py-32">
        ...
        <div className="container mx-auto grid grid-cols-1 mt-4 md:grid-cols-3 gap-12 text-center bg-gray-800 p-6 rounded-2xl shadow-lg hover:scale-105 transition-transform duration-300">

        <div className="flex flex-col items-center">
          <h3 className="text-xl font-medium mb-3 text-gray-300">Total Resumes Checked</h3>
          <AnimatedCounter value={12045} />
        </div>
        <div className="flex flex-col items-center">
          <h3 className="text-xl font-medium mb-3 text-gray-300">Users Registered</h3>
          <AnimatedCounter value={6789} />
        </div>
        <div className="flex flex-col items-center">
          <h3 className="text-xl font-medium mb-3 text-gray-300">Jobs Recommended</h3>
          <AnimatedCounter value={45321} />
        </div>
      </div>
      </div>      
      </section>
      ...
      <section className="py-20 sm:py-32">
        <div className="container">
          ...
          >
            ...
            <Link to="/ats-checker">  <Button size="lg" variant="secondary" className="mt-8 text-lg">
                Get Started Now
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button></Link>
            </div>
